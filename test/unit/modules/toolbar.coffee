...
describe('Toolbar', ->
  ...
  describe('updateActive()', ->
    it('button', ->
      ...
      expect(dom(@button).hasClass('is-active')).toBe(true)
    )
  ...
  describe('quill content methods', ->
    ...
    it('deleteText()', ->
      ...
      expect(dom(@button).hasClass('is-active')).toBe(false)
    )
    ...
    it('insertEmbed()', ->
      ...
      expect(dom(image).hasClass('is-active')).toBe(false)
    ...
    it('setHTML()', ->
      ...
      expect(dom(italic).hasClass('is-active')).toBe(false)
      @quill.setHTML('<i>italicized</i>')
      expect(dom(@button).hasClass('ql-active')).toBe(false)
      expect(dom(@button).hasClass('is-active')).toBe(false)
      expect(dom(italic).hasClass('ql-active')).toBe(true)
      expect(dom(italic).hasClass('is-active')).toBe(true)
    )
